...
public interface AlumnoDAOInterface extends Mantenible<AlumnoTO, Integer> {
  ...
  /**
   * Este metodo realiza una consulta a la tabla Alumnos buscando coincidencias 
   * por numero de recibo, no tiene que estar completo el numero del recibo.
   * 
   * @param recibo numero de recibo que se quiere consultar.
   * @return lista de Alumnos que el mumero de recibo coinciden con el parametro.
   * @throws SQLException 
   */
